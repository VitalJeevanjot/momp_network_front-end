...
<a href="https://dev.to/genievot/how-to-send-money-on-emails-using-momp-network-4pg4" target="_blank" style="text-decoration: none">
    <q-btn icon="info" color="grey-7" flat round>
        <q-tooltip>
          Verify or Update your public key with email & use same (verified) public key for automatic withdraw of any remaining balance.
        </q-tooltip>
      </q-btn>
</a>
